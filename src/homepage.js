...
export default function () {
  ...
  greetingHeading.appendChild(
    create("div", "greetings-subtext", "A little about us..")
  );
  ...
  const paragraphs = [
    `Welcome to ${em(
      "Chez Fauxmier"
    )}, where the wine is older than your father and the waiters judge you silently (but with love).`,
    ...
    `At ${em(
      "Chez Fauxmier"
    )}, every bite tells a story you don’t quite understand — and that’s exactly the point.`,
  ];
  ...
  secondHeading.appendChild(
    create("div", "greetings-subtext", "When are we open?")
  );
